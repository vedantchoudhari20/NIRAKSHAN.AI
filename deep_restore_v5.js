...
files.forEach(file => {
    ...
    console.log(`Ultimate Cleaning: ${slug}`);
    ...
    // PINPOINT REPLACEMENT: 
    // Find <div class="entry-content clear" itemprop="text">
    // Find next </article>
    const startTag = '<div class="entry-content clear" itemprop="text">';
    ...
    if (startIndex !== -1 && endIndex !== -1) {
        console.log(`Success: Found markers for ${slug}`);
        ...
        html = before + newMiddle + after;
    } else {
        console.log(`FAILURE: Missing markers for ${slug}. Start: ${startIndex}, End: ${endIndex}`);
    }

    fs.writeFileSync(file, html, 'utf8');
});

console.log("Ultimate Program Restore Complete!");
